            ...
            <div class="col-md-12">
              ...
              <div class="widget">
                <div class="widget-head">
                  <div class="pull-left">Tambah Proyek</div>
                ...
                <div class="widget-content">
                  ...
                  <?php echo form_open_multipart(base_url().'backend/proyek/tambah', array ('class' => 'form-horizontal'))?>
                      <!-- judul -->
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-lg-8">
                          <textarea name="isi" placeholder="Enter text ..." id="isi" style="width: 650px; height: 200px"></textarea>
                        </div>
                      </div>                           
                      <!-- Buttons -->
                      <div class="form-group">
