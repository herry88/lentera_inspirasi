            ...
            <div class="col-md-12">
              ...
              <div class="widget">
                ...
                <div class="widget-content">
                  ...
                  <?php echo form_open_multipart(base_url().'backend/laporan/ubah/'.+$baris->id, array ('class' => 'form-horizontal'))?>
                      <!-- bulan -->
                      <div class="form-group">
                        <label class="control-label col-lg-2" for="bulan">Bulan</label>
                        <div class="col-lg-8"> 
                          <input type="text" class="form-control" name="bulan" value="<?php echo $baris->date ?>">
                        </div>
                      </div>   
                      <div class="form-group">
                        <label class="control-label col-lg-2" for="deskripsi">Deskripsi</label>
                        <div class="col-lg-8"> 
                          <textarea type="text" class="form-control" name="deskripsi"><?php echo $baris->remarks ?></textarea>
                        </div>
                      </div>   
                      <!-- link -->
                      <div class="form-group">
