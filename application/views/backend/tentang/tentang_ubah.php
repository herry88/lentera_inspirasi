            ...
            <div class="col-md-12">
              ...
              <div class="widget">
                <div class="widget-head">
                  <div class="pull-left">Ubah Tentang Kami</div>
                ...
                <div class="widget-content">
                  ...
                  <?php echo form_open_multipart(base_url().'backend/tentang/', array ('class' => 'form-horizontal'))?> 
                      <!-- Tentang -->
                      <div class="form-group">
                        <label class="control-label col-lg-2" for="content">Tentang Kami</label>
                        <div class="col-lg-8">
